...
//
//    $Id: ampushbutton.h,v 1.2 2007/10/06 20:32:00 fredg Exp $
//
...
#ifndef AMPUSHBUTTON_H
#define AMPUSHBUTTON_H
 ...
 * Widget Defaults
 */
#define AMPUSHBUTTON_DEFAULT_FLASH_PERIOD 300
#define AMPUSHBUTTON_DEFAULT_FLASH_COLOR blue


class AMPushButton : public QPushButton
{
  Q_OBJECT
 public:
  enum ClockSource {InternalClock=0,ExternalClock=1};
  AMPushButton(QWidget *parent,const char *name=0);
  AMPushButton(const QString &text,QWidget *parent,const char *name=0);
  AMPushButton(const QIconSet &icon,const QString &text,
